  ...
  return (
    <div className='flex bg-zinc-800 text-white px-4 py-4 items-center justify-between'>
        ...
        <div className='flex gap-4'>
            <Link to="/admin/signin" className='px-2 py-1 border border-blue-500 rounded hover:bg-white hover:text-zinc-800 transition-all duration-300'>
                Admin
            </Link>
            <Link to='/user/signin' className='px-2 py-1 bg-blue-500 rounded hover:bg-white hover:text-zinc-800 transition-all duration-300'>
                User
            </Link>
        </div>
    </div>
